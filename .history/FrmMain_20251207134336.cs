      ...
      try
      {
        ...
        if (serviceController.Status == ServiceControllerStatus.Running)
        {
          ...
          if (Conversions.ToDouble(OculusTrayTool.My.MySettings.Default.FOVh) != 0.0 & Conversions.ToDouble(OculusTrayTool.My.MySettings.Default.FOVh) != 1.0 & Conversions.ToDouble(OculusTrayTool.My.MySettings.Default.FOVv) != 0.0 & Conversions.ToDouble(OculusTrayTool.My.MySettings.Default.FOVv) != 1.0)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              FrmMain._Closure\u0024__.\u0024I108\u002D8 = start = (ThreadStart) ([SpecialName] () => RunCommand.Run_debug_tool_fov("service set-client-fov-tan-angle-multiplier " + OculusTrayTool.My.MySettings.Default.FOVh + " " + OculusTrayTool.My.MySettings.Default.FOVv));
            }
            new Thread(start).Start();
          ...
          {
            // ISSUE: reference to a compiler-generated field
            FrmMain._Closure\u0024__.\u0024I108\u002D11 = start1 = (ThreadStart) ([SpecialName] () => RunCommand.Run_debug_tool_force_mipmap(OculusTrayTool.My.MySettings.Default.ForceMipmap));
          }
          ...
          {
            // ISSUE: reference to a compiler-generated field
            FrmMain._Closure\u0024__.\u0024I108\u002D12 = start2 = (ThreadStart) ([SpecialName] () => RunCommand.Run_debug_tool_offset_mipmap(OculusTrayTool.My.MySettings.Default.OffsetMipmap));
          }
