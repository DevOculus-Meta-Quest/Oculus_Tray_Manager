...
namespace OculusTrayTool
{
  public class FrmMain : Form
  {
    ...
    private Button Button1, Button2, Button4, Button5, Button11, BtnProfiles, BtnHomless, BtnRemoveAllProfiles, BtnVoice, ButtonRestartOVR, ButtonStartOVR, ButtonStopOVR;
    private Label Label1, Label5, Label6, Label7, Label8, Label9, Label13, Label15, Label16, Label17, Label18, Label19, Label29, Label33, Label35, Label37;
    private PictureBox PictureBox1, PictureBox2, PictureBox3, PictureBox5, PictureBox6;
    private ComboBox ComboBox1, ComboBox5, ComboBox8, ComboBox9, ComboMirrorHome, ComboVisualHUD, ComboOVRPrio, ComboHomless, ComboVoice, ComboSSstart;
    private CheckBox CheckRiftAudio, CheckSpoofCPU, CheckLocalDebug, CheckStartWatcher;
    private ToolStripMenuItem OpenLogToolStripMenuItem, ClearLogToolStripMenuItem, ToolStripMenuItem1, ToolStripMenuItem2, ToolStripMenuItem3, ToolStripMenuItem4, ToolStripMenuShowHome;
    private ToolStripButton ToolStripStartOVR, ToolStripStopOVR, ToolStripRestartOVR;
    private ContextMenuStrip ContextMenuStrip1, ContextMenuStrip2;
    private ToolStripSeparator ToolStripSeparator1, ToolStripSeparator2;
    private TabControl DotNetBarTabcontrol1;
    private TabPage TabPage1, TabPage2;
    private GroupBox GroupBox14;
    private TableLayoutPanel DbLayoutPanel2;
    private SplitContainer SplitContainer1;
    private NumericUpDown NumericFOVh, NumericFOVv;
    ...
    private void Form1_Load(object sender, EventArgs e)
    {
      try
      {
        ...
        else
        {
          ...
          string toolTip1 = this._toolTip.GetToolTip((Control) this.CheckSpoofCPU);
          if (string.Compare(toolTip1, (string) null, StringComparison.Ordinal) != 0 && toolTip1.Length > 75)
            this._toolTip.SetToolTip((Control) this.CheckSpoofCPU, this.SplitToolTip(toolTip1));
          string toolTip2 = this._toolTip.GetToolTip((Control) this.Label13);
          if (string.Compare(toolTip2, (string) null, StringComparison.Ordinal) != 0 && toolTip2.Length > 75)
            this._toolTip.SetToolTip((Control) this.Label13, this.SplitToolTip(toolTip2));
          string toolTip3 = this._toolTip.GetToolTip((Control) this.Label18);
          if (string.Compare(toolTip3, (string) null, StringComparison.Ordinal) != 0 && toolTip3.Length > 75)
            this._toolTip.SetToolTip((Control) this.Label18, this.SplitToolTip(toolTip3));
          string toolTip4 = this._toolTip.GetToolTip((Control) this.CheckLocalDebug);
          if (string.Compare(toolTip4, (string) null, StringComparison.Ordinal) != 0 && toolTip4.Length > 75)
            this._toolTip.SetToolTip((Control) this.CheckLocalDebug, this.SplitToolTip(toolTip4));
          string toolTip5 = this._toolTip.GetToolTip((Control) this.CheckStartWatcher);
          if (string.Compare(toolTip5, (string) null, StringComparison.Ordinal) != 0 && toolTip5.Length > 75)
            this._toolTip.SetToolTip((Control) this.CheckStartWatcher, this.SplitToolTip(toolTip5));
    ...
    private void InitializeComponent()
    {
      ...
      this._toolTip.SetToolTip((Control) this.PictureBox1, "Donate to the project");
      ...
      this._toolTip.SetToolTip((Control) this.PictureBox2, "About");
      ...
      this._toolTip.SetToolTip((Control) this.ComboSSstart, "This is the Super Sampling modifier set on startup. All VR apps that do not have a profile will inherit this setting");
      ...
      this._toolTip.SetToolTip((Control) this.ComboBox1, "This is the ASW mode set on startup. All VR apps that do not have a profile will inherit this setting");
      ...
      this._toolTip.SetToolTip((Control) this.Label1, "This is the Super Sampling modifier set on startup. All VR apps that do not have a profile will inherit this setting");
      ...
      this._toolTip.SetToolTip((Control) this.Label6, "This is the ASW mode set on startup. All VR apps that do not have a profile will inherit this setting");
      ...
      this._toolTip.SetToolTip((Control) this.ComboHomless, "Enable or Disable Oculus Homeless");
      ...
      this._toolTip.SetToolTip((Control) this.Label5, "Enable voice commands");
      ...
      this._toolTip.SetToolTip((Control) this.ComboVoice, "Enable Voice commands");
      ...
      this._toolTip.SetToolTip((Control) this.BtnVoice, "Configure Voice Commands");
      ...
      this._toolTip.SetToolTip((Control) this.Button2, "Sets the FOV on your regular 2D display. Useful when streaming gameplay.\r\nDoes not affect FOV in the Rift itself.");
      ...
      this._toolTip.SetToolTip((Control) this.PictureBox8, "Create a Profile with custom settings for each of your games.");
      ...
      this._toolTip.SetToolTip((Control) this.CheckRiftAudio, "Check to have the Rift set as default device for Audio and/or Mic when Oculus Home starts");
      ...
      this._toolTip.SetToolTip((Control) this.CheckSpoofCPU, "Check to spoof the CPU ID. Makes Oculus nag screen regarding minimum specs go away. Takes affect immediately when checked and forces a restart of the OVR service.");
      ...
      this._toolTip.SetToolTip((Control) this.ButtonRestartOVR, "Restart the Oculus service if it is running");
      ...
      this._toolTip.SetToolTip((Control) this.ButtonStartOVR, "Start the Oculus service if it is down");
      ...
      this._toolTip.SetToolTip((Control) this.ButtonStopOVR, "Stop the Oculus service if it is running");
      ...
      this._toolTip.SetToolTip((Control) this.Label29, "Enable voice commands");
      ...
      this._toolTip.SetToolTip((Control) this.CheckLocalDebug, "Use the Oculus Debug Tool shipped with OTT. Don't check this box unless you know what you are doing as it could potantially break functionality.");
      ...
      this._toolTip.SetToolTip((Control) this.CheckStartWatcher, componentResourceManager.GetString("CheckStartWatcher.ToolTip"));
      ...
      this._toolTip.SetToolTip((Control) this.Label13, "Use the Oculus Debug Tool shipped with OTT. Don't check this box unless you know what you are doing as it could potantially break functionality.");
      ...
      this._toolTip.SetToolTip((Control) this.Label18, componentResourceManager.GetString("Label18.ToolTip"));
      ...
      this._toolTip.SetToolTip((Control) this.Button4, "Reset all settings to Default");
      ...
      this._toolTip.SetToolTip((Control) this.BtnRemoveAllProfiles, "Remove all Profiles");
      ...
      this._toolTip.SetToolTip((Control) this.Button1, "Manually check if there's any updates available");
      ...
      this._toolTip.SetToolTip((Control) this.Button5, "Restart in Debug mode for additional logging");
      ...
      this._toolTip.SetToolTip((Control) this.PictureBox7, "Override distortion curvature. Higher curvature gives higher pixel density in center.");
      ...
      this._toolTip.SetToolTip((Control) this.PictureBox6, "Override encoding bitrate");
      ...
      this._toolTip.SetToolTip((Control) this.PictureBox5, "Override maximum dynamic bitrate");
      ...
      this._toolTip.SetToolTip((Control) this.PictureBox4, "Automatically adjust bitrate");
      ...
      this._toolTip.SetToolTip((Control) this.PictureBox3, "Uses Paolod29's code to patch AirLink and make it permanently enabled.\r\nYou need to run this again if the Oculus App is updated.\r\nCheck out https://github.com/pd29/oculus-airlink-enabler \r\nfor more.");
      ...
      this.Button11.Text = "+";
      this._toolTip.SetToolTip((Control) this.Button11, "Create Custom Preset");
    ...
    private void MinimizeHomeWatcher_EventArrived(object sender, EventArrivedEventArgs e)
    {
        // TODO: Implement MinimizeHomeWatcher_EventArrived logic
    }
    ...
    private void CheckStopServiceHome_CheckedChanged(object sender, EventArgs e)
    {
        // TODO: Implement CheckStopServiceHome_CheckedChanged logic
    }
    ...
    private void GetOculusLinkValues() { }
    private void CheckWarnings() { }
    private void CheckOculusService() { }
    private void StartOVR() { }
    ...
    private void InitializeComponent()
    {
        // TODO: Implement InitializeComponent logic
