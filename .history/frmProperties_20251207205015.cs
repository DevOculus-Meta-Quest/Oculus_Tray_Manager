...
namespace OculusTrayTool
{
  ...
  public class frmProperties : Form
  {
    ...
    private Label _LabelProperties;
    internal virtual Label LabelProperties
    {
      get => this._LabelProperties;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._LabelProperties = value;
    }
    ...
    private Label _LabelProperties2;
    internal virtual Label LabelProperties2
    {
      get => this._LabelProperties2;
      [MethodImpl(MethodImplOptions.Synchronized)] set => this._LabelProperties2 = value;
    }
