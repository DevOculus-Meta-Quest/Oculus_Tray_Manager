...
namespace OculusTrayTool
{
  public class FrmMain : Form
  {
    ...
    private TabControl _DotNetBarTabcontrol1;
    ...
    public virtual CheckBox CheckStartMin
    {
        ...
        {
            EventHandler eventHandler = new EventHandler(this.CheckStartMin_CheckedChanged);
            if (this._CheckStartMin != null)
                this._CheckStartMin.CheckedChanged -= eventHandler;
            this._CheckStartMin = value;
            if (this._CheckStartMin != null)
                this._CheckStartMin.CheckedChanged += eventHandler;
        }
    ...
    public void AddToListboxAndScroll_Debug(string text)
    {
    ...
    // InitializeComponent removed (duplicate)
    private void PrintSettings(bool verbose) { }
    private void OnTimerProfile(object sender, ElapsedEventArgs e) { }
