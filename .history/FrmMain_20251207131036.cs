...
namespace OculusTrayTool
{
  ...
  public class FrmMain : Form
  {
    ...
    private void Form1_Load(object sender, EventArgs e)
    {
      try
      {
        ...
        else
        {
          ...
          GetConfig.GetConfig();
          if (string.Compare(MySettingsProperty.Settings.LibraryPath, "", StringComparison.Ordinal) == 0 | string.IsNullOrWhiteSpace(MySettingsProperty.Settings.LibraryPath.ToString()))
          {
          ...
          try
          {
            if (GetDevices.AudioDevCount > 0)
            {
              if (new MMDeviceEnumerator().GetDefaultAudioEndpoint(EDataFlow.eRender, ERole.eConsole).FriendlyName.ToLower().Contains("rift"))
              {
                ...
                if (string.Compare(MySettingsProperty.Settings.DefaultAudio, (string) null, StringComparison.Ordinal) != 0 & string.Compare(MySettingsProperty.Settings.DefaultMic, (string) null, StringComparison.Ordinal) != 0)
                {
    ...
    public void LoadVoiceSettings()
    {
      ...
      if (MySettingsProperty.Settings.StartVoice == "")
      {
      ...
      if (MySettingsProperty.Settings.StopVoice == "")
      {
      ...
      listViewItem2.SubItems.Add(MySettingsProperty.Settings.StartVoiceEnabled.ToString());
      ...
      listViewItem3.SubItems.Add(MySettingsProperty.Settings.StopVoiceEnabled.ToString());
