...
using static OculusTrayTool.Conversions;
using static OculusTrayTool.Operators;
  ...
  public class FrmMain : Form
  {
          ...
          try
          {
            if (GetDevices.AudioDevCount > 0)
            {
              if (new MMDeviceEnumerator().GetDefaultAudioEndpoint(EDataFlow.eRender, ERole.eConsole).FriendlyName.ToLower().Contains("rift"))
              {
                ...
                if (string.Compare(OculusTrayTool.My.MySettings.Default.DefaultAudio, (string) null, StringComparison.Ordinal) != 0 & string.Compare(OculusTrayTool.My.MySettings.Default.DefaultMic, (string) null, StringComparison.Ordinal) != 0)
                {
    ...
    public void Shutdown()
    {
      try
      {
        ...
        SystemEvents.PowerModeChanged -= new PowerModeChangedEventHandler(this.PowerModeChanged);
        Log.WriteToLog("StopOVR is " + OculusTrayTool.My.MySettings.Default.StopOVR.ToString());
        if (OculusTrayTool.My.MySettings.Default.StopOVR)
        {
          Log.WriteToLog("Calling on service to stop");
          this.StopOVR();
        }
        else if (OculusTrayTool.My.MySettings.Default.CloseHomeOnExit)
          this.CloseClient();
        if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.PowerPlanExit, "Not Used", false) != 0 && OculusTrayTool.My.MySettings.Default.ApplyPowerPlan == 0)
        {
          PowerPlans.SetActivePowerPlan(OculusTrayTool.My.MySettings.Default.PowerPlanExit);
    ...
    public void CloseClient()
    {
      ...
      try
      {
        if (GetConfig.SetRiftDefault)
        {
          if (OculusTrayTool.My.MySettings.Default.SetRiftAudioDefault == 0)
          {
            AudioSwitcher.SetFallbackAudioDevice();
            AudioSwitcher.SetFallbackCommAudioDevice();
          }
          if (OculusTrayTool.My.MySettings.Default.SetRiftMicDefault == 0)
          {
            AudioSwitcher.SetFallbackMicDevice();
            AudioSwitcher.SetFallbackCommMicDevice();
          }
    ...
    public void GetSteamVR()
    {
      ...
      try
      {
        if (Operators.CompareString(this.SteamPath, "", false) != 0)
        {
    ...
    public void PrintSettings(bool migrate)
    {
      ...
      try
      {
        foreach (SettingsPropertyValue propertyValue in OculusTrayTool.My.MySettings.Default.PropertyValues)
    ...
    public void LoadVoiceSettings()
    {
      ...
      if (OculusTrayTool.My.MySettings.Default.StartVoice == "")
      {
        OculusTrayTool.My.MySettings.Default.StartVoice = "computer, start listening;speech on";
        OculusTrayTool.My.MySettings.Default.StartVoiceEnabled = true;
      }
      if (OculusTrayTool.My.MySettings.Default.StopVoice == "")
      {
        OculusTrayTool.My.MySettings.Default.StopVoice = "computer, stop listening;speech off";
        OculusTrayTool.My.MySettings.Default.StopVoiceEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.EnableASW, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.EnableASW = "enable spacewarp";
        OculusTrayTool.My.MySettings.Default.EnableASWEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.DisableASW, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.DisableASW = "disable spacewarp";
        OculusTrayTool.My.MySettings.Default.DisableASWEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.ShowPD, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ShowPD = "show pixel density; show super sampling";
        OculusTrayTool.My.MySettings.Default.ShowPDEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.ShowPerf, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ShowPerf = "show performance";
        OculusTrayTool.My.MySettings.Default.ShowPerfEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.Close, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.Close = "close overlay";
        OculusTrayTool.My.MySettings.Default.CloseEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.SetPD, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.SetPD = "set pixel density;set super sampling";
        OculusTrayTool.My.MySettings.Default.SetPDEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.ShowASW, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ShowASW = "show spacewarp";
        OculusTrayTool.My.MySettings.Default.ShowASWEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.LockASWOn, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.LockASWOn = "lock framerate";
        OculusTrayTool.My.MySettings.Default.LockASWOnEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.ShowLatency, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ShowLatency = "show latency timing";
        OculusTrayTool.My.MySettings.Default.ShowLatencyEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.ShowApplicationRender, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ShowApplicationRender = "show application timing";
        OculusTrayTool.My.MySettings.Default.ShowApplicationRenderEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.ShowCompositorRender, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ShowCompositorRender = "show compositor timing";
        OculusTrayTool.My.MySettings.Default.ShowCompositorRenderEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.ShowVersion, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ShowVersion = "show version";
        OculusTrayTool.My.MySettings.Default.ShowVersionEnabled = true;
      }
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.LaunchSteam, "", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.LaunchSteam = "start steam;launch steam";
        OculusTrayTool.My.MySettings.Default.LaunchSteamEnabled = true;
      }
      OculusTrayTool.My.MySettings.Default.Save();
      ...
      listViewItem2.SubItems.Add(OculusTrayTool.My.MySettings.Default.StartVoice);
      listViewItem2.SubItems.Add(OculusTrayTool.My.MySettings.Default.StartVoiceEnabled.ToString());
      ...
      listViewItem3.SubItems.Add(OculusTrayTool.My.MySettings.Default.StopVoice);
      listViewItem3.SubItems.Add(OculusTrayTool.My.MySettings.Default.StopVoiceEnabled.ToString());
      ...
      listViewItem4.SubItems.Add(OculusTrayTool.My.MySettings.Default.SetPD);
      listViewItem4.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.SetPDEnabled));
      ListViewItem listViewItem5 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Disable ASW");
      listViewItem5.SubItems.Add(OculusTrayTool.My.MySettings.Default.DisableASW);
      listViewItem5.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.DisableASWEnabled));
      ListViewItem listViewItem6 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Enable ASW");
      listViewItem6.SubItems.Add(OculusTrayTool.My.MySettings.Default.EnableASW);
      listViewItem6.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.EnableASWEnabled));
      ListViewItem listViewItem7 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("45 fps, ASW On");
      listViewItem7.SubItems.Add(OculusTrayTool.My.MySettings.Default.LockASWOn);
      listViewItem7.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.LockASWOnEnabled));
      ListViewItem listViewItem8 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Show ASW Status");
      listViewItem8.SubItems.Add(OculusTrayTool.My.MySettings.Default.ShowASW);
      listViewItem8.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.ShowASWEnabled));
      ListViewItem listViewItem9 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Show Pixel Density");
      listViewItem9.SubItems.Add(OculusTrayTool.My.MySettings.Default.ShowPD);
      listViewItem9.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.ShowPDEnabled));
      ListViewItem listViewItem10 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Show Performance");
      listViewItem10.SubItems.Add(OculusTrayTool.My.MySettings.Default.ShowPerf);
      listViewItem10.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.ShowPerfEnabled));
      ListViewItem listViewItem11 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Show Latency Timing");
      listViewItem11.SubItems.Add(OculusTrayTool.My.MySettings.Default.ShowLatency);
      listViewItem11.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.ShowLatencyEnabled));
      ListViewItem listViewItem12 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Show Application Render Timing");
      listViewItem12.SubItems.Add(OculusTrayTool.My.MySettings.Default.ShowApplicationRender);
      listViewItem12.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.ShowApplicationRenderEnabled));
      ListViewItem listViewItem13 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Show Compositor Render Timing");
      listViewItem13.SubItems.Add(OculusTrayTool.My.MySettings.Default.ShowCompositorRender);
      listViewItem13.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.ShowCompositorRenderEnabled));
      ListViewItem listViewItem14 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Show Version Info");
      listViewItem14.SubItems.Add(OculusTrayTool.My.MySettings.Default.ShowVersion);
      listViewItem14.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.ShowVersionEnabled));
      ListViewItem listViewItem15 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Close Overlay");
      listViewItem15.SubItems.Add(OculusTrayTool.My.MySettings.Default.Close);
      listViewItem15.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.CloseEnabled));
      ListViewItem listViewItem16 = MyProject.Forms.frmVoiceSettings.ListView1.Items.Add("Launch SteamVR");
      listViewItem16.SubItems.Add(OculusTrayTool.My.MySettings.Default.LaunchSteam);
      listViewItem16.SubItems.Add(Conversions.ToString(OculusTrayTool.My.MySettings.Default.LaunchSteamEnabled));
    ...
    private void CheckStartWithWindows()
    {
      ...
      try
      {
        this.CheckStartWindows.Checked = OculusTrayTool.My.MySettings.Default.StartWithWindows;
        if (!Globals.dbg)
          return;
      ...
      try
      {
        ...
        if (this.isElevated)
        {
          ...
          else
          {
            ...
            if (Operators.ConditionalCompareObjectNotEqual(MyProject.Computer.Registry.LocalMachine.OpenSubKey("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", true).GetValue(Application.ProductName), (object) null, false))
    ...
    public void CheckOculusService()
    {
      ...
      try
      {
        ...
        if (serviceController.Status == ServiceControllerStatus.Running)
        {
          ...
          if (Operators.CompareString(GetConfig.ppdpstartup, "", false) != 0 & Operators.CompareString(GetConfig.ppdpstartup, "0", false) != 0)
          {
            new Thread(() => RunCommand.Run_debug_tool(GetConfig.ppdpstartup)).Start();
          }
          this.ComboOVRPrio.Text = OculusTrayTool.My.MySettings.Default.OVRSrvPrio;
          if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.OVRSrvPrio, "Normal", false) != 0)
            this.ChangeCPUPrioOVR(OculusTrayTool.My.MySettings.Default.OVRSrvPrio);
          if (OculusTrayTool.My.MySettings.Default.ASW == 0)
          {
            new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Auto")).Start();
            this.AddToListboxAndScroll("ASW set to Auto");
            this.ComboBox1.Text = "Auto";
          }
          if (OculusTrayTool.My.MySettings.Default.ASW == 1)
          {
            new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Off")).Start();
            this.AddToListboxAndScroll("ASW set to Off");
            this.ComboBox1.Text = "Off";
          }
          if (OculusTrayTool.My.MySettings.Default.ASW == 2)
          {
            new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Clock45")).Start();
            this.AddToListboxAndScroll("Framerate @ 45 Hz");
            this.ComboBox1.Text = "45 Hz";
          }
          if (OculusTrayTool.My.MySettings.Default.ASW == 3)
          {
            new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Clock30")).Start();
            this.AddToListboxAndScroll("Framerate @ 30 Hz");
            this.ComboBox1.Text = "30 Hz";
          }
          if (OculusTrayTool.My.MySettings.Default.ASW == 4)
          {
            new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Clock18")).Start();
            this.AddToListboxAndScroll("Framerate @ 18 Hz");
            this.ComboBox1.Text = "18 Hz";
          }
          if (OculusTrayTool.My.MySettings.Default.ASW == 5)
          {
            new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Sim45")).Start();
            this.AddToListboxAndScroll("Framerate forced to 45 Hz");
            this.ComboBox1.Text = "45 Hz forced";
          }
          if (OculusTrayTool.My.MySettings.Default.ASW == 6)
          {
            new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Adaptive")).Start();
            this.AddToListboxAndScroll("Framerate set to Adaptive");
            this.ComboBox1.Text = "Adaptive";
          }
          if (Conversions.ToDouble(OculusTrayTool.My.MySettings.Default.FOVh) != 0.0 & Conversions.ToDouble(OculusTrayTool.My.MySettings.Default.FOVh) != 1.0 & Conversions.ToDouble(OculusTrayTool.My.MySettings.Default.FOVv) != 0.0 & Conversions.ToDouble(OculusTrayTool.My.MySettings.Default.FOVv) != 1.0)
          {
            new Thread(() => RunCommand.Run_debug_tool_fov("service set-client-fov-tan-angle-multiplier " + OculusTrayTool.My.MySettings.Default.FOVh + " " + OculusTrayTool.My.MySettings.Default.FOVv)).Start();
            this.AddToListboxAndScroll("FOV set to " + OculusTrayTool.My.MySettings.Default.FOVh + "; " + OculusTrayTool.My.MySettings.Default.FOVv);
          }
          if (OculusTrayTool.My.MySettings.Default.AdaptiveGPUScaling)
          {
          ...
          new Thread(() => RunCommand.Run_debug_tool_force_mipmap(OculusTrayTool.My.MySettings.Default.ForceMipmap)).Start();
          new Thread(() => RunCommand.Run_debug_tool_offset_mipmap(OculusTrayTool.My.MySettings.Default.OffsetMipmap)).Start();
          this.ComboVisualHUD.SelectedIndex = 0;
    ...
    public void StartOVR()
    {
      ...
      try
      {
        ...
        try
        {
          ...
          {
            if (Operators.CompareString(managementBaseObject.GetPropertyValue("StartMode").ToString().Replace("\"", ""), "Disabled", false) == 0)
            {
        ...
        if (serviceController.Status == ServiceControllerStatus.Stopped)
        {
          ...
          Log.WriteToLog("Sleeping for " + Conversions.ToString(OculusTrayTool.My.MySettings.Default.SleepAfterServiceStart) + "ms after service start");
          Thread.Sleep(OculusTrayTool.My.MySettings.Default.SleepAfterServiceStart);
          this.CheckOculusService();
      ...
      try
      {
        ...
        try
        {
          foreach (ManagementObject managementObject in managementObjectSearcher.Get())
          {
            ...
            {
              (object) "0"
            }, (string[]) null, (Type[]) null, (bool[]) null).ToString().TrimEnd('_').ToUpper().Contains("ROOT_HUB_FL30") && Operators.ConditionalCompareObjectEqual(managementObject.GetPropertyValue("Enable"), (object) true, false))
            {
    ...
    private void CheckStartMin_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        if (GetConfig.IsReading)
          return;
        OculusTrayTool.My.MySettings.Default.StartMinimized = this.CheckStartMin.Checked;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
      ...
      try
      {
        ...
        if (processesByName.Length > 0)
        {
          ...
          if (!this.NoProfileFound)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              FrmMain._Closure\u0024__.\u0024I120\u002D4 = start5 = (ThreadStart) ([SpecialName] () => RunCommand.Run_debug_tool_force_mipmap(OculusTrayTool.My.MySettings.Default.ForceMipmap.ToString().ToLower()));
            }
            ...
            {
              // ISSUE: reference to a compiler-generated field
              FrmMain._Closure\u0024__.\u0024I120\u002D5 = start6 = (ThreadStart) ([SpecialName] () => RunCommand.Run_debug_tool_offset_mipmap(OculusTrayTool.My.MySettings.Default.OffsetMipmap.ToString()));
            }
            ...
            {
              // ISSUE: reference to a compiler-generated field
              FrmMain._Closure\u0024__.\u0024I120\u002D6 = start7 = (ThreadStart) ([SpecialName] () => RunCommand.Run_debug_tool_fov("service set-client-fov-tan-angle-multiplier " + OculusTrayTool.My.MySettings.Default.FOVh + " " + OculusTrayTool.My.MySettings.Default.FOVv));
            }
            new Thread(start7).Start();
            if (GetConfig.SetRiftDefault)
            {
              if (OculusTrayTool.My.MySettings.Default.SetRiftAudioDefault == 2)
              {
                ThreadStart start8;
                // ISSUE: reference to a compiler-generated field
              ...
              if (OculusTrayTool.My.MySettings.Default.SetRiftMicDefault == 2)
              {
                ThreadStart start9;
                // ISSUE: reference to a compiler-generated field
    ...
    private void CheckStartService_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        if (GetConfig.IsReading)
          return;
        OculusTrayTool.My.MySettings.Default.StartOVR = this.CheckStartService.Checked;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
    ...
    private void CheckStopService_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        if (GetConfig.IsReading)
          return;
        OculusTrayTool.My.MySettings.Default.StopOVR = this.CheckStopService.Checked;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
    ...
    private void CheckLaunchHome_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        ...
        if (this.CheckLaunchHome.Checked)
        {
          OculusTrayTool.My.MySettings.Default.StartHomeOnServiceStart = true;
          this.CheckLaunchHomeTool.Checked = false;
        }
        else
          OculusTrayTool.My.MySettings.Default.StartHomeOnServiceStart = false;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
    ...
    private void CheckLaunchHomeTool_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        ...
        {
          OculusTrayTool.My.MySettings.Default.StartHomeOnToolStart = true;
          this.CheckLaunchHome.Checked = false;
        }
        else
          OculusTrayTool.My.MySettings.Default.StartHomeOnToolStart = false;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
    ...
    private void CheckCloseHome_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        if (GetConfig.IsReading)
          return;
        OculusTrayTool.My.MySettings.Default.CloseHomeOnExit = this.CheckCloseHome.Checked;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
    ...
    private void CheckBoxAltTab_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        ...
        {
          OculusTrayTool.My.MySettings.Default.HideAltTab = true;
          GetConfig.hideAltTab = true;
        }
        else
        {
          OculusTrayTool.My.MySettings.Default.HideAltTab = false;
    ...
    private void CheckRiftAudio_CheckedChanged(object sender, EventArgs e)
    {
      ...
      {
        OculusTrayTool.My.MySettings.Default.SetRiftAsDefault = true;
        GetConfig.SetRiftDefault = true;
        OculusTrayTool.My.MySettings.Default.Save();
        if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.DefaultAudio, "", false) == 0 | Operators.CompareString(OculusTrayTool.My.MySettings.Default.DefaultMic, "", false) == 0)
        {
          this.Cursor = Cursors.WaitCursor;
      ...
      {
        OculusTrayTool.My.MySettings.Default.SetRiftAsDefault = false;
    ...
    private void StartWatcherNoHome()
    {
      try
      {
        if (GetConfig.SetRiftDefault)
        {
          if (OculusTrayTool.My.MySettings.Default.SetRiftAudioDefault == 0)
          {
            new Thread(() => AudioSwitcher.SetDefaultAudioDeviceOnStart(false)).Start();
          }
          if (OculusTrayTool.My.MySettings.Default.SetRiftMicDefault == 0)
          {
            new Thread(() => AudioSwitcher.SetDefaultMicDeviceOnStart()).Start();
          }
        }
        if (OTTDB.numWMI > 0)
          this.CreateWatcher();
    ...
    private void OculusHomeWatcher_Tick(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (OculusTrayTool.My.MySettings.Default.ApplyPowerPlan == 1)
        {
          PowerPlans.SetActivePowerPlan(OculusTrayTool.My.MySettings.Default.PowerPlanStart);
          PowerPlans.GetSetUsbSuspend(PowerPlans.filter, false);
        }
        if (OculusTrayTool.My.MySettings.Default.SendHomeToTray)
        {
        ...
        if (OculusTrayTool.My.MySettings.Default.MirrorHome)
        {
          this._Home2Timer.Elapsed += new ElapsedEventHandler(this._Home2TimerElapsed);
          this._Home2Timer.Start();
        }
        if (OculusTrayTool.My.MySettings.Default.UseVoiceCommands)
          this.EnableDisableVoice(true);
        this.kbHook = !OculusTrayTool.My.MySettings.Default.UseHotKeys ? (KeyboardHook) null : new KeyboardHook();
      }
      catch (Exception ex)
      {
        ProjectData.SetProjectError(ex);
        ...
        foreach (KeyValuePair<string, string> profileTimer in this.profileTimerList)
        {
          ...
          if (processesByName1.Length > 0)
          {
            try
            {
              ...
              new Thread(() => RunCommand.Run_debug_tool(this.CurrentSS)).Start();
              
              string fov = "";
              if (this.profileFOV.TryGetValue(this.runningApp.ToLower(), out fov))
              {
                new Thread(() => RunCommand.Run_debug_tool_fov(fov)).Start();
              }
              string forceMipmap = "";
              if (this.profileForceMipMap.TryGetValue(this.runningApp.ToLower(), out forceMipmap))
              {
                new Thread(() => RunCommand.Run_debug_tool_force_mipmap(forceMipmap)).Start();
              }
              string offsetMipmap = "";
              if (this.profileOffsetMipMap.TryGetValue(this.runningApp.ToLower(), out offsetMipmap))
              {
                new Thread(() => RunCommand.Run_debug_tool_offset_mipmap(offsetMipmap)).Start();
              }
              string Left1 = "";
              ...
              if (!GetConfig.SetRiftDefault | OculusTrayTool.My.MySettings.Default.SetRiftAudioDefault != 2 && OculusTrayTool.My.MySettings.Default.VoiceConfirmProfile)
              {
              ...
              if (GetConfig.SetRiftDefault)
              {
                if (OculusTrayTool.My.MySettings.Default.SetRiftAudioDefault == 2)
                {
                  if (OculusTrayTool.My.MySettings.Default.VoiceConfirmProfile)
                  {
                      new Thread(() => AudioSwitcher.SetDefaultAudioDeviceOnStart(true)).Start();
                  }
                  else
                  {
                      new Thread(() => AudioSwitcher.SetDefaultAudioDeviceOnStart(false)).Start();
              ...
              if (Operators.ConditionalCompareObjectNotEqual(this.GetCurrentResolution(), (object) OculusTrayTool.My.MySettings.Default.DesktopResolution, false))
              {
                // ISSUE: object of a compiler-generated type is created
                // ISSUE: variable of a compiler-generated type
                FrmMain._Closure\u0024__136\u002D1 closure1361 = new FrmMain._Closure\u0024__136\u002D1(closure1361);
                this.AddToListboxAndScroll("Setting Desktop resolution to " + OculusTrayTool.My.MySettings.Default.DesktopResolution);
                Log.WriteToLog("Setting Desktop resolution to " + OculusTrayTool.My.MySettings.Default.DesktopResolution);
                string[] strArray = Strings.Split(OculusTrayTool.My.MySettings.Default.DesktopResolution, "x");
                // ISSUE: reference to a compiler-generated field
    ...
    private void Watcher_EventArrived(object sender, EventArrivedEventArgs e)
    {
      try
      {
        ...
        if (Operators.CompareString(Path.GetFileNameWithoutExtension(this.runningApp), "OculusDash", false) == 0 && Operators.CompareString(OculusTrayTool.My.MySettings.Default.OVRSrvPrio, "Normal", false) != 0)
          new Thread((ThreadStart) ([SpecialName] () => this.ChangeCPUPrioDash(OculusTrayTool.My.MySettings.Default.OVRSrvPrio))).Start();
        string str1 = "";
        if (this.profileList.TryGetValue(this.appName, out str1))
        {
          ...
          if (Operators.ConditionalCompareObjectNotEqual(this.GetCurrentResolution(), (object) OculusTrayTool.My.MySettings.Default.DesktopResolution, false))
          {
            ...
            new Thread(() => Resolution.ChangeDisplaySettings((int) integer1, (int) integer2)).Start();
          }
          if (Globals.dbg)
            Log.WriteToLog("Starting AppWatchWorker in 2 seconds");
          Thread.Sleep(2000);
    ...
    public void ApplyCpuPrioTick(object sender, ElapsedEventArgs e)
    {
      try
      {
        ...
        if (Operators.CompareString(this.runningApp, "", false) == 0)
        {
          this.cpuTimer.Enabled = false;
          this.cpuTimer.Elapsed -= new ElapsedEventHandler(this.ApplyCpuPrioTick);
        }
        else
        {
          ...
          if (this.profilePriorityList.TryGetValue(this.runningApp.ToLower(), out Left))
          {
            ...
            while (index < processesByName.Length)
            {
              ...
              if (Operators.CompareString(Left, "Normal", false) != 0)
              {
                if (Operators.CompareString(Left, "Above Normal", false) != 0)
                {
                  if (Operators.CompareString(Left, "High", false) == 0)
                  {
    ...
    public void ApplyAswTick(object sender, ElapsedEventArgs e)
    {
      try
      {
        ...
        {
          string Left = "";
          if (this.profileASWList.TryGetValue(this.runningApp.ToLower(), out Left) && Operators.CompareString(Left, "Inherit", false) != 0)
          {
            if (Operators.CompareString(Left, "Auto", false) == 0)
            {
              new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Auto")).Start();
            ...
            if (Operators.CompareString(Left, "45 Hz", false) == 0 | Operators.CompareString(Left, "45 fps", false) == 0)
            {
              new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Clock45")).Start();
            ...
            if (Operators.CompareString(Left, "30 Hz", false) == 0)
            {
              new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Clock30")).Start();
            ...
            if (Operators.CompareString(Left, "18 Hz", false) == 0)
            {
              new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Clock18")).Start();
            ...
            if (Operators.CompareString(Left, "45 Hz forced", false) == 0)
            {
              new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Sim45")).Start();
            ...
            if (Operators.CompareString(Left, "Adaptive", false) == 0)
            {
              new Thread(() => RunCommand.Run_debug_tool_asw("server:asw.Adaptive")).Start();
    ...
    private void HomeWork(object sender, DoWorkEventArgs e)
    {
      ...
      if (OculusTrayTool.My.MySettings.Default.SendHomeToTray | OculusTrayTool.My.MySettings.Default.SendHomeToTrayOnStart)
        this.StartMinimizeHomeWatcher();
      if (GetConfig.SetRiftDefault)
      {
        if (OculusTrayTool.My.MySettings.Default.SetRiftAudioDefault == 0)
      ...
      if (OculusTrayTool.My.MySettings.Default.StopOVRHome)
      {
        Thread.Sleep(1000);
        this.StopOVR();
      }
    ...
    {
      this.Cursor = Cursors.WaitCursor;
      if (Operators.CompareString(this.ToolStripMenuItem3.Text, "Set Rift as default Audio/Mic", false) == 0)
      {
        if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.RiftAudioGuid, (string) null, false) != 0)
          RiftDefault.SetRiftDefaultAudioDevice();
        if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.RiftMicGuid, (string) null, false) != 0)
      ...
      {
        if (Operators.CompareString(this.ToolStripMenuItem3.Text, "Set Fallback as default Audio/Mic", false) == 0)
        {
          if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.SystemDefaultAudioGuid, (string) null, false) != 0)
          {
            AudioSwitcher.SetFallbackAudioDevice();
          }
          else
          ...
          if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.SystemDefaultMicGuid, (string) null, false) != 0)
          {
            AudioSwitcher.SetFallbackMicDevice();
          }
          else
          ...
          if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.SystemDefaultCommGuid, (string) null, false) != 0)
          {
            AudioSwitcher.SetFallbackCommMicDevice();
          }
          else
          ...
          if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.SystemDefaultCommAudioGuid, (string) null, false) != 0)
          {
            AudioSwitcher.SetFallbackCommAudioDevice();
          }
          else
        ...
        if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.SystemDefaultAudioGuid, (string) null, false) == 0 & Operators.CompareString(OculusTrayTool.My.MySettings.Default.SystemDefaultMicGuid, (string) null, false) == 0)
        {
      ...
      try
      {
        ...
        if (this.isElevated)
        {
          if (this.CheckSpoofCPU.Checked)
          {
            ...
            OculusTrayTool.My.MySettings.Default.SpoofCPU = true;
            this.spoofid = true;
            OculusTrayTool.My.MySettings.Default.OldCPUID = "";
          ...
          {
            OculusTrayTool.My.MySettings.Default.SpoofCPU = false;
            this.spoofid = false;
            this.RestoreCPUID();
          }
          OculusTrayTool.My.MySettings.Default.Save();
    ...
    public void GetCPUid()
    {
      ...
      try
      {
        ...
        if (Operators.CompareString(this.cpuid, "Intel(R) Core(TM) i7-4770K CPU @ 3.90GHz", false) == 0 | Operators.CompareString(this.cpuid, "AMD Ryzen 7 1700X Eight-Core Processor", false) == 0)
        {
        ...
        {
          if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.OldCPUID, "", false) == 0)
          {
            OculusTrayTool.My.MySettings.Default.OldCPUID = this.cpuid;
            OculusTrayTool.My.MySettings.Default.Save();
    ...
    private void RestoreCPUID()
    {
      ...
      try
      {
        if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.OldCPUID, "", false) != 0)
        {
          MyProject.Computer.Registry.LocalMachine.OpenSubKey("HARDWARE\\DESCRIPTION\\System\\CentralProcessor\\0", true).SetValue("ProcessorNameString", (object) OculusTrayTool.My.MySettings.Default.OldCPUID);
          Log.WriteToLog("CPU ID restored to: " + OculusTrayTool.My.MySettings.Default.OldCPUID);
          this.AddToListboxAndScroll("CPU ID restored to: " + OculusTrayTool.My.MySettings.Default.OldCPUID);
          OculusTrayTool.My.MySettings.Default.OldCPUID = "";
        }
        else
    ...
    internal string SplitToolTip(string strOrig)
    {
      ...
      if (Expression.Length < 8 && str3.Length >= 2)
        str3 = str3.Substring(0, checked (str3.Length - 2));
      return str3 + Expression;
    }

    public static string GenerateSHA256Hash(string path)
    {
    ...
    private void CheckMinimizeOnX_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        ...
        {
          OculusTrayTool.My.MySettings.Default.CloseOnX = false;
          OculusTrayTool.My.MySettings.Default.ShowStillRunning = true;
        }
        else
          OculusTrayTool.My.MySettings.Default.CloseOnX = true;
        OculusTrayTool.My.MySettings.Default.Save();
        GetConfig.IsReading = false;
      }
      catch (Exception ex)
    ...
    {
      this.Cursor = Cursors.WaitCursor;
      MyProject.Forms.frmLibrary.Location = OculusTrayTool.My.MySettings.Default.LibraryWindowLocation;
      MyProject.Forms.frmLibrary.Size = OculusTrayTool.My.MySettings.Default.LibraryWindowSize;
    ...
    {
      MyProject.Forms.frmProfiles.Location = OculusTrayTool.My.MySettings.Default.ProfilesWindowLocation;
      MyProject.Forms.frmProfiles.Size = OculusTrayTool.My.MySettings.Default.ProfilesWindowSize;
    ...
    {
      MyProject.Forms.frmVoiceSettings.Size = OculusTrayTool.My.MySettings.Default.VoiceDialogSize;
    ...
    private void TrackBar1_Scroll(object sender, EventArgs e)
    {
      this.Label14.Text = "Font Size: " + this.TrackBar1.Value.ToString();
      this.rs.ResizeAllControls((Control) this, (float) this.TrackBar1.Value);
      OculusTrayTool.My.MySettings.Default.FontSize = (float) this.TrackBar1.Value;
      OculusTrayTool.My.MySettings.Default.Save();
      MyProject.Forms.frmProfiles.ListView1.Font = new Font(MyProject.Forms.frmProfiles.ListView1.Font.Name, OculusTrayTool.My.MySettings.Default.FontSize, FontStyle.Regular);
      MyProject.Forms.frmProfiles.ListView1.AutoResizeColumns(ColumnHeaderAutoResizeStyle.HeaderSize);
    }
    ...
    private void ComboBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (GetConfig.IsReading)
        return;
      if (Operators.CompareString(this.ComboBox1.Text, "Auto", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ASW = 0;
        ThreadStart start;
        // ISSUE: reference to a compiler-generated field
      ...
      if (Operators.CompareString(this.ComboBox1.Text, "Off", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ASW = 1;
        ThreadStart start;
        // ISSUE: reference to a compiler-generated field
      ...
      if (Operators.CompareString(this.ComboBox1.Text, "45 Hz", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ASW = 2;
        ThreadStart start;
        // ISSUE: reference to a compiler-generated field
      ...
      if (Operators.CompareString(this.ComboBox1.Text, "30 Hz", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ASW = 3;
        ThreadStart start;
        // ISSUE: reference to a compiler-generated field
      ...
      if (Operators.CompareString(this.ComboBox1.Text, "18 Hz", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ASW = 4;
        ThreadStart start;
        // ISSUE: reference to a compiler-generated field
      ...
      if (Operators.CompareString(this.ComboBox1.Text, "45 Hz forced", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ASW = 5;
        ThreadStart start;
        // ISSUE: reference to a compiler-generated field
      ...
      if (Operators.CompareString(this.ComboBox1.Text, "Adaptive", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.ASW = 6;
        ThreadStart start;
        // ISSUE: reference to a compiler-generated field
    ...
    private void ComboVoice_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (GetConfig.IsReading)
        return;
      if (Operators.CompareString(this.ComboVoice.Text, "Enabled", false) == 0)
      {
        OculusTrayTool.My.MySettings.Default.UseVoiceCommands = true;
        OculusTrayTool.My.MySettings.Default.Save();
        this.EnableDisableVoice(true);
      }
      else
      {
        OculusTrayTool.My.MySettings.Default.UseVoiceCommands = false;
        OculusTrayTool.My.MySettings.Default.Save();
    ...
    public void EnableDisableVoice(bool enable)
    {
      if (enable)
      {
        ...
        if (!this.HomeIsRunning)
          return;
        if (OculusTrayTool.My.MySettings.Default.JoystickActivationKeyContinous | OculusTrayTool.My.MySettings.Default.JoystickActivationKeyPush && Operators.CompareString(OculusTrayTool.My.MySettings.Default.JoystickVoiceActivationButton, "", false) != 0)
        {
          ThreadStart start;
          // ISSUE: reference to a compiler-generated field
    ...
    private void HotKeysCheckBox_CheckedChanged(object sender, EventArgs e)
    {
      ...
      {
        OculusTrayTool.My.MySettings.Default.UseHotKeys = true;
      ...
      {
        OculusTrayTool.My.MySettings.Default.UseHotKeys = false;
        GetConfig.UseHotKeys = false;
    ...
    private void ComboPowerPlan_SelectedIndexChanged(object sender, EventArgs e)
    {
      try
      {
        if (GetConfig.IsReading)
          return;
        OculusTrayTool.My.MySettings.Default.PowerPlanStart = this.ComboPowerPlanStart.Text;
        OculusTrayTool.My.MySettings.Default.Save();
        if (Operators.CompareString(this.ComboPowerPlanStart.Text, "Not Used", false) != 0)
        {
          if (OculusTrayTool.My.MySettings.Default.ApplyPowerPlan == 0)
          {
            PowerPlans.SetActivePowerPlan(OculusTrayTool.My.MySettings.Default.PowerPlanStart);
            PowerPlans.GetSetUsbSuspend(PowerPlans.filter, false);
          }
    ...
    private void ComboUSBsusp_SelectedIndexChanged(object sender, EventArgs e)
    {
      try
      {
        ...
        if (this.ComboUSBsusp.SelectedIndex == 0)
        {
          ...
          OculusTrayTool.My.MySettings.Default.USBSuspend = 0;
        }
        else
        {
          Log.WriteToLog("Enabling USB Selective Suspend");
          PowerPlans.GetSetUsbSuspend(PowerPlans.filter, true);
          OculusTrayTool.My.MySettings.Default.USBSuspend = 1;
        }
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
        ...
        while (index < processesByName.Length)
        {
          ...
          if (Operators.CompareString(Left, "Normal", false) != 0)
          {
            if (Operators.CompareString(Left, "Above normal", false) != 0)
            {
              if (Operators.CompareString(Left, "High", false) != 0)
              {
                if (Operators.CompareString(Left, "Realtime", false) == 0)
                {
    ...
    private void CheckSendHomeToTray_CheckedChanged(object sender, EventArgs e)
    {
      ...
      {
        OculusTrayTool.My.MySettings.Default.SendHomeToTray = true;
        if (this.HomeIsRunning)
        {
          if (Globals.dbg)
      ...
      else
      {
        ...
        OculusTrayTool.My.MySettings.Default.SendHomeToTray = false;
        this.HometoTrayTimer.Enabled = false;
        OculusTrayTool.My.MySettings.Default.ShowHomeToast = true;
        OculusTrayTool.My.MySettings.Default.Save();
      }
    }
    ...
    private void CheckSendHomeToTrayOnStart_CheckedChanged(object sender, EventArgs e)
    {
      ...
      {
        this.StartMinimizeHomeWatcher();
        OculusTrayTool.My.MySettings.Default.SendHomeToTrayOnStart = true;
        OculusTrayTool.My.MySettings.Default.Save();
        if (this.HomeIsRunning)
        {
          HomeToTray.SendHomeToTrayOnStart();
      ...
      {
        OculusTrayTool.My.MySettings.Default.SendHomeToTrayOnStart = false;
        OculusTrayTool.My.MySettings.Default.ShowHomeToast = true;
        OculusTrayTool.My.MySettings.Default.Save();
        this.MinimizeHomeWatcher.Stop();
      }
    ...
    private void CheckLocalDebug_CheckedChanged(object sender, EventArgs e)
    {
      ...
      {
        OculusTrayTool.My.MySettings.Default.UseLocalDebugTool = true;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      else
      {
        OculusTrayTool.My.MySettings.Default.UseLocalDebugTool = false;
        OculusTrayTool.My.MySettings.Default.Save();
      }
    }
    ...
    private void CheckStartWatcher_CheckedChanged(object sender, EventArgs e)
    {
      ...
      {
        OculusTrayTool.My.MySettings.Default.StartAppwatcherOnStart = true;
        OculusTrayTool.My.MySettings.Default.Save();
        if (this.OculusServiceFound)
        {
      ...
      {
        OculusTrayTool.My.MySettings.Default.StartAppwatcherOnStart = false;
        OculusTrayTool.My.MySettings.Default.Save();
      }
    }
    ...
    private void BtnRemoveAllProfiles_Click(object sender, EventArgs e)
    {
      ...
      if (Directory.Exists(this.OculusPath.TrimEnd('\\') + "\\CoreData\\Manifests"))
        GetGames.GetThirdPartyApps(this.OculusPath.TrimEnd('\\') + "\\CoreData\\Manifests");
      if (Operators.CompareString(OculusTrayTool.My.MySettings.Default.LibraryPath, "", false) != 0)
      {
        string[] strArray = Strings.Split(OculusTrayTool.My.MySettings.Default.LibraryPath, ",");
        int index = 0;
        while (index < strArray.Length)
    ...
    private void Button5_Click(object sender, EventArgs e)
    {
      if (Interaction.MsgBox((object) "Restart in Debug mode?", MsgBoxStyle.YesNo | MsgBoxStyle.Question, (object) "Confirm restart") != MsgBoxResult.Yes)
        return;
      OculusTrayTool.My.MySettings.Default.RunDebug = true;
      OculusTrayTool.My.MySettings.Default.Save();
    ...
    private void CheckSensorPower_CheckedChanged(object sender, EventArgs e)
    {
      try
      {
        if (GetConfig.IsReading)
          return;
        OculusTrayTool.My.MySettings.Default.DisableSensorPower = this.CheckSensorPower.Checked;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
    ...
    private void ComboPowerPlanExit_SelectedIndexChanged(object sender, EventArgs e)
    {
      try
      {
        if (GetConfig.IsReading)
          return;
        OculusTrayTool.My.MySettings.Default.PowerPlanExit = this.ComboPowerPlanExit.Text;
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
    ...
    private void ComboApplyPlan_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (GetConfig.IsReading)
        return;
      OculusTrayTool.My.MySettings.Default.ApplyPowerPlan = this.ComboApplyPlan.SelectedIndex;
      OculusTrayTool.My.MySettings.Default.Save();
    ...
    private void CheckBoxCheckForUpdates_CheckedChanged(object sender, EventArgs e)
    {
      if (GetConfig.IsReading)
        return;
      OculusTrayTool.My.MySettings.Default.AutomaticUpdateCheck = this.CheckBoxCheckForUpdates.Checked;
      OculusTrayTool.My.MySettings.Default.Save();
    }
    ...
    private void Button2_Click(object sender, EventArgs e)
    {
      try
      {
        OculusTrayTool.My.MySettings.Default.FOVh = Conversions.ToString(this.NumericFOVh.Value);
        OculusTrayTool.My.MySettings.Default.FOVv = Conversions.ToString(this.NumericFOVv.Value);
        OculusTrayTool.My.MySettings.Default.Save();
        new Thread(() => RunCommand.Run_debug_tool_fov(OculusTrayTool.My.MySettings.Default.FOVh.ToString() + " " + OculusTrayTool.My.MySettings.Default.FOVv.ToString())).Start();
      }
      catch (Exception ex)
      {
        ProjectData.SetProjectError(ex);
    ...
    private void InstallHomeless()
    {
      ...
      try
      {
        OculusTrayTool.My.MySettings.Default.HomelessHash = Conversions.ToString(this.GenerateSHA256Hash(Application.StartupPath + "\\Homeless\\Home2-Win64-Shipping.exe"));
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
      ...
      try
      {
        OculusTrayTool.My.MySettings.Default.HomeHash = Conversions.ToString(this.GenerateSHA256Hash(this.OculusPath + "Support\\oculus-worlds\\Home2\\Binaries\\Win64\\Home2-Win64-Shipping.exe"));
        OculusTrayTool.My.MySettings.Default.Save();
      }
      catch (Exception ex)
      {
      ...
      if (File.Exists(Application.StartupPath + "\\Homeless\\Backup\\Home2-Win64-Shipping.exe"))
      {
        ...
        OculusTrayTool.My.MySettings.Default.HomelessEnabled = this.ComboHomless.SelectedIndex;
        OculusTrayTool.My.MySettings.Default.Save();
      }
    }
    ...
    private void UninstallHomeless()
    {
      ...
      try
      {
        if (File.Exists(this.OculusPath + "Support\\oculus-worlds\\Home2\\Binaries\\Win64\\Home2-Win64-Shipping.exe_ORG"))
        {
          if (Operators.CompareString(Conversions.ToString(this.GenerateSHA256Hash(this.OculusPath + "Support\\oculus-worlds\\Home2\\Binaries\\Win64\\Home2-Win64-Shipping.exe_ORG")), OculusTrayTool.My.MySettings.Default.HomeHash, false) == 0)
          {
        ...
        else
        {
          ...
          if (Operators.CompareString(Conversions.ToString(this.GenerateSHA256Hash(Application.StartupPath + "\\Homeless\\Backup\\Home2-Win64-Shipping.exe")), OculusTrayTool.My.MySettings.Default.HomeHash, false) == 0)
          {
    ...
    private void ComboMirrorHome_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      {
        OculusTrayTool.My.MySettings.Default.MirrorHome = true;
        ...
        OculusTrayTool.My.MySettings.Default.MirrorHome = false;
      OculusTrayTool.My.MySettings.Default.Save();
    }
    ...
    {
      if (double.TryParse("1", out double mode1) && (double) args.Mode == mode1)
      {
      ...
      if (double.TryParse("2", out double mode2) && (double) args.Mode == mode2)
      {
        Log.WriteToLog("Computer is in an unknown power state");
        this.AddToListboxAndScroll("Computer is in an unknown power state");
      }
      if (double.TryParse("3", out double mode3) && (double) args.Mode != mode3)
        return;
    ...
    private void CheckRestartSleep_CheckedChanged(object sender, EventArgs e)
    {
      ...
      {
        OculusTrayTool.My.MySettings.Default.RestartServiceAfterSleep = true;
        if (Globals.dbg)
          Log.WriteToLog("Adding eventhandler for PowerModeChanged");
        SystemEvents.PowerModeChanged += new PowerModeChangedEventHandler(this.PowerModeChanged);
      }
      ...
      {
        OculusTrayTool.My.MySettings.Default.RestartServiceAfterSleep = false;
        if (Globals.dbg)
          Log.WriteToLog("Removing eventhandler for PowerModeChanged");
        SystemEvents.PowerModeChanged -= new PowerModeChangedEventHandler(this.PowerModeChanged);
      }
    ...
    private void kbHook_KeyDown(Keys Key)
    {
      ...
      {
        if (Operators.CompareString(Left1, "ASW Auto", false) == 0)
        {
          this.AddToListboxAndScroll("Setting ASW to Auto");
          RunCommand.Run_debug_tool_asw("server:asw.Auto");
          if (OculusTrayTool.My.MySettings.Default.HotKeyVoiceConfirmation)
          {
            ThreadStart start;
            // ISSUE: reference to a compiler-generated field
        ...
        if (Operators.CompareString(Left1, "ASW Off", false) == 0)
        {
        ...
        if (Operators.CompareString(Left1, "ASW 45", false) == 0)
        {
        ...
        if (Operators.CompareString(Left1, "Close HUD", false) == 0)
          RunCommand.Run_debug_tool_info("perfhud reset\r\nlayerhud reset");
        if (Operators.CompareString(Left1, "HUD ASW Mode", false) == 0)
          RunCommand.Run_debug_tool_info("layerhud set-mode 0\r\nperfhud set-mode 6");
        if (Operators.CompareString(Left1, "HUD Performance", false) == 0)
          RunCommand.Run_debug_tool_info("layerhud set-mode 0\r\nperfhud set-mode 1");
        if (Operators.CompareString(Left1, "HUD Pixel Density", false) == 0)
          RunCommand.Run_debug_tool_info("layerhud set-mode 1\r\nperfhud set-mode 0");
        if (Operators.CompareString(Left1, "HUD Latency", false) == 0)
          RunCommand.Run_debug_tool_info("layerhud set-mode 0\r\nperfhud set-mode 2");
        if (Operators.CompareString(Left1, "HUD Application Render", false) == 0)
          RunCommand.Run_debug_tool_info("layerhud set-mode 0\r\nperfhud set-mode 3");
        if (Operators.CompareString(Left1, "HUD Compositor Render", false) == 0)
          RunCommand.Run_debug_tool_info("layerhud set-mode 0\r\nperfhud set-mode 4");
        if (Operators.CompareString(Left1, "Exit running VR app", false) == 0)
        {
          try
          {
            if (Operators.CompareString(this.runningAppExe, "cmd.exe", false) != 0 & Operators.CompareString(this.runningapp_displayname, "", false) != 0 & this.pid != 0)
            {
        ...
        if (Operators.CompareString(Left1, "Next HUD", false) == 0)
        {
        ...
        if (Operators.CompareString(Left1, "Previous HUD", false) == 0)
        {
          if (this.ComboVisualHUD.SelectedIndex == 0)
        ...
        if (Operators.CompareString(Left1, "Next ASW Mode", false) == 0)
        {
          ...
          if (Operators.CompareString(Left2, "45", false) == 0)
          {
            this.AddToListboxAndScroll("Setting ASW to Clock45");
            ThreadStart start1;
            // ISSUE: reference to a compiler-generated field
          ...
          if (Operators.CompareString(Left2, "Auto", false) == 0)
          {
            this.AddToListboxAndScroll("Setting ASW to Auto");
            ThreadStart start5;
            // ISSUE: reference to a compiler-generated field
          ...
          if (Operators.CompareString(Left2, "30", false) == 0)
          {
          ...
          if (Operators.CompareString(Left2, "18", false) == 0)
          {
          ...
          if (Operators.CompareString(Left2, "45f", false) == 0)
          {
          ...
          if (Operators.CompareString(Left2, "Adaptive", false) == 0)
          {
        ...
        if (Operators.CompareString(Left1, "Previous ASW Mode", false) == 0)
        {
          ...
          if (Operators.CompareString(Left3, "45", false) == 0)
          {
          ...
          if (Operators.CompareString(Left3, "Off", false) == 0)
          {
            this.AddToListboxAndScroll("Setting ASW to Off");
            RunCommand.Run_debug_tool_asw("server:asw.Off");
            if (OculusTrayTool.My.MySettings.Default.HotKeyVoiceConfirmation)
          ...
          if (Operators.CompareString(Left3, "Auto", false) == 0)
          {
            this.AddToListboxAndScroll("Setting ASW to Auto");
            RunCommand.Run_debug_tool_asw("server:asw.Auto");
            if (OculusTrayTool.My.MySettings.Default.HotKeyVoiceConfirmation)
          ...
          if (Operators.CompareString(Left3, "30", false) == 0)
          {
            this.AddToListboxAndScroll("Setting ASW to 30Hz");
            ThreadStart start15;
            // ISSUE: reference to a compiler-generated field
          ...
          if (Operators.CompareString(Left3, "18", false) == 0)
          {
            this.AddToListboxAndScroll("Setting ASW to 18Hz");
            ThreadStart start17;
            // ISSUE: reference to a compiler-generated field
          ...
          if (Operators.CompareString(Left3, "45f", false) == 0)
          {
            this.AddToListboxAndScroll("Setting ASW to 45Hz (forced)");
            ThreadStart start19;
            // ISSUE: reference to a compiler-generated field
          ...
          if (Operators.CompareString(Left3, "Adaptive", false) == 0)
          {
            this.AddToListboxAndScroll("Setting ASW to Adaptive");
            ThreadStart start21;
            // ISSUE: reference to a compiler-generated field
      ...
      if (Operators.CompareString(Key.ToString().ToUpper(), OculusTrayTool.My.MySettings.Default.KeyboardVoiceActivationKey, false) == 0)
      {
        if (OculusTrayTool.My.MySettings.Default.VoiceActivationKeyContinous)
        {
          if (!VoiceCommands.isListening)
          {
        ...
        if (OculusTrayTool.My.MySettings.Default.VoiceActivationKeyPush && !VoiceCommands.isListening)
        {
          if (!OculusTrayTool.My.MySettings.Default.DisableVoiceControlAudioFeedback)
          {
            ThreadStart start;
    ...
    {
      if (!this.HomeIsRunning || Operators.CompareString(Key.ToString().ToUpper(), OculusTrayTool.My.MySettings.Default.KeyboardVoiceActivationKey, false) != 0 || !OculusTrayTool.My.MySettings.Default.VoiceActivationKeyPush)
        return;
      if (!OculusTrayTool.My.MySettings.Default.DisableVoiceControlAudioFeedback)
      {
        ThreadStart start;
    ...
    private void PowerPlanTimer_Tick(object sender, EventArgs e)
    {
      ...
      try
      {
        foreach (ManagementObject managementObject in objectCollection)
        {
          ...
          {
            if (Operators.CompareString(managementObject["ElementName"].ToString(), OculusTrayTool.My.MySettings.Default.PowerPlanCurrent, false) != 0)
            {
              ...
              PowerPlans.SetActivePowerPlan(OculusTrayTool.My.MySettings.Default.PowerPlanCurrent);
              PowerPlans.GetSetUsbSuspend(PowerPlans.filter, false);
              break;
            }
            break;
    ...
    private void ComboBox4_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      this.ComboBox10.SelectedIndex = Convert.ToInt32(OTTDB.GetLinkPresetValueByName(this.ComboBox4.Text, "DBR"));
    ...
    private void SaveOculusLinkValues(bool restart)
    {
      ...
      {
        this.Cursor = Cursors.WaitCursor;
        if (Operators.CompareString(this.ComboBox4.Text, "Disabled", false) == 0)
        {
        ...
        else
        {
          ...
          if (Operators.CompareString(this.ComboBox6.Text, "", false) != 0)
          {
          ...
          if (Operators.CompareString(this.ComboBox7.Text, "", false) != 0)
          {
            if (Operators.CompareString(this.ComboBox7.Text, "Disabled", false) == 0)
            {
            ...
            if (Operators.CompareString(this.ComboBox7.Text, "Enabled", false) == 0)
            {
              registryKey.SetValue("LinkSharpeningEnabled", (object) "2", RegistryValueKind.DWord);
              Log.WriteToLog("Quest Link option set: LinkSharpeningEnabled = " + this.ComboBox7.Text);
            }
            if (Operators.CompareString(this.ComboBox7.Text, "Auto", false) == 0 && registryKey.GetValue("LinkSharpeningEnabled", (object) null) != null)
            {
          ...
          if (Operators.CompareString(this.ComboBox11.Text, "0", false) == 0)
          {
          ...
          if (Operators.CompareString(this.ComboBox4.Text, "GTX 970+", false) == 0 | Operators.CompareString(this.ComboBox4.Text, "GTX 1070+", false) == 0 | Operators.CompareString(this.ComboBox4.Text, "RTX 2070+", false) == 0 | Operators.CompareString(this.ComboBox4.Text, "GTX 1080Ti/RTX 2080+", false) == 0)
          {
            this.isCopy = true;
    ...
    public void GetOculusLinkValues()
    {
      try
      {
        ...
        if (registryKey.GetValue("DistortionCurve", (object) null) != null)
        {
          if (Operators.ConditionalCompareObjectEqual(registryKey.GetValue("DistortionCurve", (object) null), (object) "0", false))
            this.ComboBox2.Text = "Low";
          else if (Operators.ConditionalCompareObjectEqual(registryKey.GetValue("DistortionCurve", (object) null), (object) "1", false))
        ...
        {
          if (Operators.ConditionalCompareObjectEqual(registryKey.GetValue("LinkSharpeningEnabled", (object) null), (object) "1", false))
            this.ComboBox7.Text = "Disabled";
          else if (Operators.ConditionalCompareObjectEqual(registryKey.GetValue("LinkSharpeningEnabled", (object) null), (object) "2", false))
        ...
        if (registryKey.GetValue("DBR", (object) null) != null)
        {
          if (Operators.ConditionalCompareObjectEqual(registryKey.GetValue("DBR", (object) null), (object) "1", false))
            this.ComboBox10.Text = "Enabled";
          else if (Operators.ConditionalCompareObjectEqual(registryKey.GetValue("DBR", (object) null), (object) "0", false))
        ...
        if (Operators.CompareString(presetValueByValues, "", false) != 0)
        {
    ...
    private void ComboBox5_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      {
        OculusTrayTool.My.MySettings.Default.AdaptiveGPUScaling = true;
        OculusTrayTool.My.MySettings.Default.Save();
        if (!this.OVRIsRunning)
          return;
      ...
      {
        OculusTrayTool.My.MySettings.Default.AdaptiveGPUScaling = false;
        OculusTrayTool.My.MySettings.Default.Save();
        if (this.OVRIsRunning)
        {
    ...
    {
      if (GetConfig.IsReading || Operators.CompareString(this.ComboOVRPrio.SelectedItem.ToString(), "", false) == 0)
        return;
      this.ChangeCPUPrioOVR(this.ComboOVRPrio.SelectedItem.ToString());
      OculusTrayTool.My.MySettings.Default.OVRSrvPrio = this.ComboOVRPrio.SelectedItem.ToString();
    }
    ...
    private void ComboBox8_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (GetConfig.IsReading)
        return;
      OculusTrayTool.My.MySettings.Default.ForceMipmap = this.ComboBox8.Text;
      OculusTrayTool.My.MySettings.Default.Save();
      ThreadStart start;
      // ISSUE: reference to a compiler-generated field
      ...
      {
        // ISSUE: reference to a compiler-generated field
        FrmMain._Closure\u0024__.\u0024I239\u002D0 = start = (ThreadStart) ([SpecialName] () => RunCommand.Run_debug_tool_force_mipmap(OculusTrayTool.My.MySettings.Default.ForceMipmap.ToString().ToLower()));
      }
      new Thread(start).Start();
    }
    ...
    private void ComboBox9_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (GetConfig.IsReading)
        return;
      OculusTrayTool.My.MySettings.Default.OffsetMipmap = this.ComboBox9.Text;
      OculusTrayTool.My.MySettings.Default.Save();
      ThreadStart start;
      // ISSUE: reference to a compiler-generated field
      ...
      {
        // ISSUE: reference to a compiler-generated field
        FrmMain._Closure\u0024__.\u0024I240\u002D0 = start = (ThreadStart) ([SpecialName] () => RunCommand.Run_debug_tool_offset_mipmap(OculusTrayTool.My.MySettings.Default.OffsetMipmap.ToString()));
      }
      new Thread(start).Start();
    }
    ...
    public virtual System.Windows.Forms.Timer NotificationTimer
    {
