...
namespace OculusTrayTool
{
  internal sealed class AirLink
  {
    ...
    public static void EnableAirLink()
    {
      ...
      {
        string cmd4 = "Add-Content \"" + FrmMain.fmain.OculusPath + "Support\\oculus-client\\resources\\app\\output\\main.js\" (New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/pd29/oculus-airlink-enabler/main/airlink.js')";
        FrmMain.fmain.AddToListboxAndScroll("Checking for chocolatey");
        ...
        {
          FrmMain.fmain.AddToListboxAndScroll("Installing chocolatey..");
          ...
          {
            FrmMain.fmain.AddToListboxAndScroll("chocolatey installed");
          }
          else
          {
