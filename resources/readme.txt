...
* Added "FoV Multiplier" to Profiles. Setting this to a value lower than 1, for example 0.8,
  ...
  NOTE: This does currently not with the Quest due to Link needing to be restarted
...
* The "Default Super Sampling" drop-down is now also user-editable. Type what you want and hit Enter.
